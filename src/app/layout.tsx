...
export const metadata: Metadata = {
  title: "Elite Coaching | Professional Sports Training & Fitness Coaching",  description: "Transform your fitness with expert personal coaching. Customized training programs for strength, cardio, and nutrition. Book your free consultation today.",  keywords: "personal training, sports coaching, fitness coach, strength training, endurance coaching",  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Elite Coaching | Professional Sports Training",    description: "Expert personal coaching to help you achieve your fitness goals",    siteName: "Elite Coaching",    type: "website",    images: [{
      url: "http://img.b2bpic.net/free-photo/woman-gym-with-coach_1303-5545.jpg",      alt: "Elite Coaching - Professional Sports Training"
    }]
  },
  twitter: {
    card: "summary_large_image",    title: "Elite Coaching | Professional Sports Training",    description: "Transform your fitness with expert personal coaching",    images: ["http://img.b2bpic.net/free-photo/woman-gym-with-coach_1303-5545.jpg"]
  }
};
